...
public class Animal extends AnimalFrame implements ButtonController,
     ...
     * initialization can refer to the Animal object.
     *
     * @param appletUsage if true, mark as running in Applet context.
     * @param codeBase    the base URL for the (potential) applet
     */
    ...
    public static Animal get() {
        ...
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentStart(AnimalStartUpProgress.PROGRESS_LABEL_CreatingnewAnimalinstance);
        // MessageDisplay.addDebugMessage("create new instance");
        if (animal == null) {
            animal = new Animal();
        }
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentEnd(AnimalStartUpProgress.PROGRESS_LABEL_CreatingnewAnimalinstance);

        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentStart(AnimalStartUpProgress.PROGRESS_LABEL_LoadingAnimalproperties);
        ...
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentStart(AnimalStartUpProgress.PROGRESS_LABEL_Initializingdefaultlocale);
...
//    Animal.advanceProgressDisplay(5);
     ...
     *
     * @param argv the invocation parameters
     */
    ...
    private static void startAnimal(String[] argv) {
        ...
        animal.init();
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentStart(AnimalStartUpProgress.PROGRESS_LABEL_ParseArguments);
        animal.parseArguments(argv);
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentEnd(AnimalStartUpProgress.PROGRESS_LABEL_ParseArguments);
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentStart(AnimalStartUpProgress.PROGRESS_LABEL_FinalStart);
        if (Animation.get() == null)
            animal.newFile();
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentEnd(AnimalStartUpProgress.PROGRESS_LABEL_FinalStart);
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentStart(AnimalStartUpProgress.PROGRESS_LABEL_HideProgressDisplay);
        Animal.hideProgressDisplay();
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentEnd(AnimalStartUpProgress.PROGRESS_LABEL_HideProgressDisplay);
    ...
    public void init() {
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentStart(AnimalStartUpProgress.PROGRESS_LABEL_InitializingAnimal);
        ...
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentStart(AnimalStartUpProgress.PROGRESS_LABEL_InstantiateAnimalmainwindow);
        ...
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentStart(AnimalStartUpProgress.PROGRESS_LABEL_InitializeAllEditors);
...
//    Animal.advanceProgressDisplay(10);
        if (Animal.ProgressPanel != null)
            Animal.ProgressPanel.addTextWithPercentEnd(AnimalStartUpProgress.PROGRESS_LABEL_InitializeAllEditors);
     ...
     *
     * @param af the actual font name to be used
     */
     ...
     * Animal session.
     *
     * @param b true - do so, false don't load but create a new Animation instead.
     */
     ...
     *
     * @param b true - use file compression,
     *          <p>
     ...
     * title bar.
     *
     * @param filename the filename to be set. If it is <strong>null </strong>, the title
...
//    startAnimationFromAnimalScriptCodeFunc("");
     ...
     *
     * @param name the name of the Editor to get, not containing the package name.
